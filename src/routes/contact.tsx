...
function ContactPage() {
  return (
    <SimpleContentPage
      titleAr="تواصل معنا"titleEn="Contact Us"introAr="نرحب بتواصلك عبر القنوات الرسمية لمنصة أقلع. أقلع ليست خدمة طوارئ."introEn="Reach Aqla through our official channels. Aqla is not an emergency service."
      sectionsAr={[
