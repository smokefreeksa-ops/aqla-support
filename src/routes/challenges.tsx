      ...
      <main className="mx-auto max-w-6xl px-4 py-10 sm:py-14">
        ...
        <section className="text-center">
          ...
          <p className="mx-auto mt-4 max-w-3xl text-muted-foreground sm:text-lg">
            {isAr
              ? "مكان واحد يجمع أدوات أقلع، التحديات، خريطة المدن، الأوسمة، دعوة الأصدقاء، والبطاقات التوعوية. شارك، تعلّم، اجمع النقاط، وساعد في نشر الوعي دون عرض أي بيانات شخصية.": "One place for Aqla tools, challenges, city map, medals, friend invites, and awareness cards. Participate, learn, collect points, and help spread awareness without displaying personal data."}
          </p>
        ...
        <section className="mt-12">
          ...
          <div className="mt-4 grid gap-4 sm:grid-cols-3">
            <LeaderboardCard
              ...
              href="/learn-train"icon={<Trophy className="h-5 w-5" />}
            />
            <LeaderboardCard
              ...
              href="/learn-train"icon={<Award className="h-5 w-5" />}
            />
            <LeaderboardCard
              ...
              href="/city-challenge"icon={<MapPin className="h-5 w-5" />}
            />
          </div>
        </section>
        ...
        <section className="mt-12">
          <Card className="rounded-3xl border-0 p-6 sm:p-8 shadow-elegant card-gradient">
            ...
            <ul className="mt-4 grid gap-2 sm:grid-cols-2">
              {(isAr
                ? [
                    "أكمل تحدي المعرفة", "صمم منشورًا توعويًا", "شارك رابط الدعوة", "أنشئ وعد إقلاع", "ساعد شخصًا برسالة دعم", "أكمل تدريب المتطوعين", "شارك تحدي مدينتك",
                  ]
                : [
                    "Complete a knowledge challenge", "Create an awareness poster", "Share your invite link", "Create a quit pledge", "Help someone with a support message", "Complete volunteer training", "Share your city challenge",
                  ]
              ).map((it, i) => (
            ...
            <p className="mt-4 rounded-xl bg-primary-soft/70 p-3 text-sm text-foreground/80">
              {isAr
                ? "النقاط تكافئ نشر الوعي والمشاركة المجتمعية، ولا تعتمد على الحالة الصحية أو سرعة الإقلاع.": "Points reward awareness and community participation, not health status or quitting speed."}
            </p>
          </Card>
        </section>
          ...
          <Card className="rounded-2xl border-l-4 border-l-destructive p-4">
            <div className="flex gap-3">
              ...
              <p className="text-sm leading-7">
                {isAr
                  ? "هذه التحديات للتوعية والدعم المجتمعي فقط. لا تمثل تشخيصًا أو علاجًا أو نصيحة طبية شخصية. إذا كنت تعاني من أعراض طارئة مثل ألم شديد في الصدر أو ضيق تنفس شديد، فاطلب الرعاية الطبية العاجلة.": "These challenges are for awareness and community support only. They are not diagnosis, treatment, or personal medical advice. If you have urgent symptoms such as severe chest pain or severe shortness of breath, seek urgent medical care."}
              </p>
            </div>
          </Card>
        </section>
