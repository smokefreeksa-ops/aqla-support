  ...
  return (
    <div dir={dir} className="min-h-screen bg-background">
      ...
      <main className="mx-auto max-w-3xl px-4 py-10 sm:py-14">
        ...
        <Link
          to="/dtx"
          className="mt-6 block rounded-2xl border border-cyan-500/40 bg-gradient-to-br from-cyan-950 via-slate-900 to-slate-950 p-5 hover:border-cyan-400/80 transition group"
        >
          <div className="flex items-center gap-3">
