...
function PointsMedalsPage() {
  return (
    <SimpleContentPage
      titleAr="النقاط والأوسمة"titleEn="Points & Medals"introAr="تُمنح النقاط والأوسمة للمشاركة التوعوية الآمنة مثل دعوة الأصدقاء، تصميم البطاقات، وتحديات المعرفة والمدن. لا تعتمد على بيانات صحية خاصة."introEn="Points and medals reward safe awareness participation such as inviting friends, designing cards, and joining knowledge or city challenges. They are not based on private health data."
      sectionsAr={[
