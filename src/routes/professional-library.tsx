      ...
      <main className="mx-auto max-w-3xl px-4 py-12 sm:py-16">
        <div className={isAr ? "text-right": ""}>
          ...
          <p className="mt-3 text-[14.5px] leading-7 text-foreground/75">
            {isAr
              ? "مكتبة موجّهة للمختصين الصحيين والمتطوعين المعتمدين، تتضمن مراجع الأدوات السريرية المعتمدة (FTND, PSECDI, PS-NDI, HONC, LWDS-11) وإرشادات الاستخدام.": "A library for health specialists and certified volunteers — references for validated clinical tools (FTND, PSECDI, PS-NDI, HONC, LWDS-11) and usage guidance."}
          </p>
        </div>
        ...
        <Card className={`mt-6 rounded-2xl p-6 ${isAr ? "text-right": ""}`}>
          ...
          <p className="mt-3 text-[13.5px] leading-7 text-foreground/75">
            {isAr
              ? "هذه المكتبة متاحة للمختصين الصحيين والمتطوعين الذين أكملوا التدريب. سجّل دخولك من بوابة الموظفين، أو ابدأ التدريب التطوعي للحصول على صلاحية الوصول.": "This library is available to health specialists and volunteers who completed training. Sign in via the staff portal, or start volunteer training to gain access."}
          </p>
