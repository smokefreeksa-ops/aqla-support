...
export const Route = createFileRoute("/articles/shisha")({
  ...
  component: () => (
    <ArticleScaffold
      titleAr="الإقلاع عن المعسل والشيشة"titleEn="Quitting shisha and waterpipe"intro="هيكل المقال جاهز، والمحتوى قيد الكتابة."
      sections={[
        "كيف يختلف المعسل عن السجائر", "المحفزات الاجتماعية والجلسات", "خطوات التوقف التدريجي أو الفوري", "بدائل التعامل مع الرغبة", "الدعم المتاح عبر أقلع",
      ]}
    />
  ),
});
