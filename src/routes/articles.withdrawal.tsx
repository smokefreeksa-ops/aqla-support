...
export const Route = createFileRoute("/articles/withdrawal")({
  ...
  component: () => (
    <ArticleScaffold
      titleAr="أعراض انسحاب النيكوتين وكم تستمر"titleEn="Nicotine withdrawal symptoms and how long they last"intro="هيكل المقال جاهز، والمحتوى العلمي قيد الكتابة من قِبل الفريق."
      sections={[
        "لماذا تحدث أعراض الانسحاب", "الأعراض الشائعة", "الجدول الزمني: من الساعات الأولى إلى الأسابيع", "طرق التعامل المدعومة بالأدلة", "علامات تستدعي مراجعة مختص",
      ]}
    />
  ),
});
