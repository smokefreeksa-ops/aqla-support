...
export const Route = createFileRoute("/try/shoot")({
  head: () => ({
    meta: [
      { title: "صوّب على السجائر — لعبة أقلع | Aqla" },
      {
        name: "description",
        content:
          "٣٠ ثانية لصوّب على السجائر وتحطيمها. جرّب لعبة أقلع التفاعلية بدون تسجيل.",
      },
      { property: "og:title", content: "صوّب على السجائر — لعبة أقلع" },
      {
        property: "og:description",
        content: "٣٠ ثانية لصوّب على السجائر وتحطيمها. جرّبها الآن بدون تسجيل.",
      },
    ],
  }),
  component: ShootPage,
