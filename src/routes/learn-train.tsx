      ...
      <main className="mx-auto max-w-3xl px-4 py-10 sm:py-14">
        <div className={isAr ? "text-right" : "text-left"}>
          ...
          <p className="mt-3 max-w-xl text-[14px] leading-7 text-foreground/70">
            {isAr
              ? "مركز تعليمي تفاعلي للتدريب على دعم الإقلاع عن التدخين والنيكوتين، مع سيناريوهات، تدريب عملي، اختبار نهائي، وشهادة قابلة للتحميل والمشاركة والتحقق."
              : "Interactive academy for training in cessation support, with scenarios, hands-on practice, a final exam, and a shareable verifiable certificate."}
          </p>
        </div>
