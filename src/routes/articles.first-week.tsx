...
export const Route = createFileRoute("/articles/first-week")({
  ...
  component: () => (
    <ArticleScaffold
      ...
      intro="دليل مُنظّم لأول سبعة أيام بعد قرار الإقلاع — الهيكل جاهز والمحتوى قيد الكتابة."
      sections={[
        "قبل يوم التوقف: التحضير",
        "اليوم الأول: ما الذي تتوقعه",
        "الأيام 2–3: ذروة الرغبة",
        "الأيام 4–7: بناء الروتين الجديد",
        "متى تطلب دعمًا مختصًا",
      ]}
    />
  ),
});
