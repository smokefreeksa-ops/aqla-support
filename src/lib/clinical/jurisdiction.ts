...
const SA_PROFILE: JurisdictionProfile = {
  ...
  services: [
    "حجز موعد عيادة إقلاع عن التدخين عبر تطبيق «صحتي».", "استشارة صحية عبر مركز 937 (وزارة الصحة).",
  ],
};
...
const GENERIC_PROFILE: JurisdictionProfile = {
  ...
  services: [
    "مراجعة طبيب الأسرة أو أقرب خدمة صحية في بلدك.", "خدمة الإقلاع عن التدخين المحلية إن وُجدت.",
  ],
};
