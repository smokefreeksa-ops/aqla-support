...
export const SHISHA_SESSIONS = [
  "أقل من جلسة أسبوعيًا", "جلسة 1–2", "جلسات 3–5", "يوميًا أو شبه يومي",
];
export const SHISHA_DURATION = [
  "أقل من 30 دقيقة", "30–60 دقيقة", "1–2 ساعة", "أكثر من ساعتين",
];
export const VAPE_PATTERNS = [
  "مرات قليلة في اليوم", "على فترات كثيرة", "طوال اليوم تقريبًا", "أول شيء بعد الاستيقاظ", "لا أعرف الكمية",
];
export const POUCH_FREQ = [
  "1–3", "4–8", "أكثر من 8", "أستخدمها عند الرغبة فقط",
];
...
export const PREV_ATTEMPTS = [
  "لا", "نعم، أقل من 24 ساعة", "نعم، عدة أيام", "نعم، أسبوع أو أكثر", "نعم، شهر أو أكثر", "نعم، أكثر من 3 أشهر ثم عدت",
];

export const RELAPSE_CAUSES = [
  "رغبة شديدة", "عصبية أو توتر", "جلسة أصدقاء", "شيشة", "قهوة", "قيادة", "بعد الأكل", "زيادة الشهية أو الوزن", "حزن أو ضغط نفسي", "قلت: واحدة فقط", "لم أستخدم علاجًا أو دعمًا", "لا أعرف",
];
...
export const PERSONAL_REASONS = [
  "صحتي ونفسي", "أطفالي أو أسرتي", "الرائحة والشكل", "المال", "الدين والجسد كأمانة", "الرياضة والطاقة", "النوم والتركيز", "الاستعداد لعملية أو علاج", "الحمل أو حماية طفل", "كرامتي وحريتي من النيكوتين", "شخص أحبه طلب مني", "لا أعرف، لكن أشعر أن الوقت حان",
];

export const STEP_TITLES = [
  "المنتج ونمط الاستخدام", "أول استخدام بعد الاستيقاظ", "كمية الاستخدام", "خريطة المحفزات", "الاستعداد والثقة والدافعية", "محاولات الإقلاع السابقة", "فحص السلامة والإحالة", "معنى الإقلاع والأسباب الشخصية",
];
