...
export function FloatingWhatsAppButton({ forceVisible = false }: { forceVisible?: boolean } = {}) {
  ...
  const tooltip = isAr ? "تواصل عبر واتساب" : "Contact via WhatsApp";
  ...
  return (
    ...
    >
      <a
        ...
        draggable={false}
        className="flex h-12 w-12 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg transition-shadow hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-[#25D366]/40 motion-reduce:transition-none"
      >
        <svg
