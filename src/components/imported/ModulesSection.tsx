        ...
        <div className="mb-16 md:mb-20">
          ...
          <div className="max-w-3xl">
            ...
            <p className="text-lg md:text-xl text-gray-500 leading-relaxed max-w-2xl mb-5">
              {isAr
                ? "منهج ثنائي اللغة مبني على مصادر منظمة الصحة العالمية (WHO) ومراكز مكافحة الأمراض الأمريكية (CDC).": "Bilingual curriculum grounded in WHO and U.S. CDC evidence."}
            </p>
          ...
          {MODULES.map((mod) => (
            <Link
              ...
              className={`group relative p-5 rounded-xl overflow-hidden transition-all duration-300 ${
                mod.featured
                  ? "bg-gradient-to-br from-brand to-ink-secondary text-white shadow-xl shadow-emerald-700/30 hover:shadow-2xl hover:-translate-y-1": "glass-card"} ${mod.wide ? "md:col-span-2": ""}`}
            >
