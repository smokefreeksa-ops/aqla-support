      ...
      <div className="pointer-events-none relative flex flex-wrap items-center justify-between gap-3 px-4 py-2.5 sm:py-3">
        <div className="relative z-10 flex flex-wrap items-center gap-2 sm:gap-3 order-1">
          ...
          <button
            ...
            className="pointer-events-auto relative z-10 rounded-full bg-white text-red-800 text-[12px] sm:text-[13px] font-bold px-3 py-1 hover:bg-rose-50 transition"
          >
            انضم بسرعة
          </button>
          <Link
            to="/challenge-pathway"
            className="pointer-events-auto relative z-10 inline-flex items-center gap-1.5 rounded-full bg-emerald-500/95 text-white text-[12px] sm:text-[13px] font-bold px-3 py-1 hover:bg-emerald-600 transition shadow-sm"
          >
