    ...
    <div dir={dir} lang={lang} className="min-h-screen bg-background text-foreground">
      ...
      <footer className="border-t border-border/60 bg-card/60">
        <div className="mx-auto max-w-4xl px-4 py-8 text-[13px] text-muted-foreground">
          ...
          <p className="mt-4">
            {isAr
              ? "بالانتساب إلى جامعة الملك عبدالعزيز — كلية العلوم الطبية التطبيقية، جدة، المملكة العربية السعودية."
              : "In affiliation with King Abdulaziz University — Faculty of Applied Medical Sciences, Jeddah, Saudi Arabia."}
          </p>
