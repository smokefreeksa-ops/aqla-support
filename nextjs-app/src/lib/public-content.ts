...
export const publicPageContent: Record<PublicPageKey, PublicPageContent> = {
  ...
  privacy: {
    ...
    sections: [
      ...
      { titleAr: 'معرّف تقني للمتصفح', titleEn: 'Technical browser identifier', bodyAr: 'قد يستخدم أقلع معرّفًا عشوائيًا في ملف ارتباط آمن لقياس الزيارات والحد من إساءة استخدام خدمات الضيف. لا يحتوي هذا المعرّف على اسمك أو بريدك الإلكتروني أو تفاصيل خطتك الصحية، ولا يُستخدم لنشر بيانات صحية فردية.', bodyEn: 'Aqla may use a random identifier in a secure browser cookie for visit measurement and abuse prevention in guest services. The identifier does not contain your name, email address or health-plan details and is not used to publish individual health information.' },
