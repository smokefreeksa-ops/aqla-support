...
export const publicPageContent: Record<PublicPageKey, PublicPageContent> = {
  ...
  faq: {
    ...
    sections: [
      ...
      { titleAr: 'هل أستطيع العودة إلى خطتي؟', titleEn: 'Can I return to my plan?', bodyAr: 'نعم، عند تسجيل الدخول تُحفظ الخطة المرتبطة بحسابك ويمكن فتح أحدث خطة من لوحة أقلع.', bodyEn: 'Yes. When signed in, your plan is linked to your account and your latest plan can be reopened from the Aqla dashboard.' },
      { titleAr: 'متى تكون المتابعة؟', titleEn: 'When are the check-ins?', bodyAr: 'الخطة الحالية تستخدم نقاط متابعة بعد 3 أيام و7 أيام و30 يومًا لمراجعة التقدم وتحديد الخطوة التالية.', bodyEn: 'The current plan uses Day 3, Day 7 and Day 30 check-ins to review progress and determine the next useful step.' },
  ...
  privacy: {
    ...
    sections: [
      ...
      { titleAr: 'البريد والمتابعة', titleEn: 'Email and follow-up', bodyAr: 'رسائل أقلع مصممة لتكون مختصرة وألا تتضمن تفاصيل صحية غير ضرورية. الروابط تعيدك إلى التجربة المحمية داخل حسابك.', bodyEn: 'Aqla messages are designed to be brief and avoid unnecessary health details. Links return you to the protected experience in your account.' },
      { titleAr: 'الدراسة البحثية', titleEn: 'Research study', bodyAr: 'الدراسة البحثية مسار منفصل عن دعم الإقلاع. اختيار عدم المشاركة لا يمنع استخدام خطة أقلع.', bodyEn: 'The research study is a separate pathway from cessation support. Choosing not to participate does not block access to an Aqla plan.' },
    ],
  },
  terms: {
