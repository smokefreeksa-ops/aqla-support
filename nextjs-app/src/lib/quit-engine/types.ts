...
export type FirstUseAfterWaking = 'lt_5' | '6_30' | '31_60' | 'gt_60' | 'not_daily'
...
export type DependenceCategory = 'low_ritual' | 'moderate' | 'high' | 'complex_mixed'
...
export interface EngineResult {
  ...
  hsi_score?: number
  aqla_support_intensity: number
  aqla_support_intensity_label: string
...
export interface StoredQuitPlan {
  plan_id: string
  created_at: string
  version: 1
  persisted: boolean
